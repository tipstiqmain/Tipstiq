...
func init() {
	googleClientID := os.Getenv("532951057245-1rltmg715cngv5ah666p5avnf89fg13n.apps.googleusercontent.com")
	googleClientSecret := os.Getenv("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")
